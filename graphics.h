...
extern "C"
{
	...
	Uint32 _fgcolor, _bgcolor, _fontcolor, _fillcolor; //global color numbers
	pid_t _pid;										   //Don't bother with this
	int _curfillstyle;								   //fill styles
	...
	int getfillcolor();
	void setfillstyle(int fillcolor, int fillstyle);

	/*** library specific functions - not for users ***/
	void initialize_settings(void);
	void mappixel(int, int);
	void mapfillpixel(int, int);  //marks a pixel without updating screen
